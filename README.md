...
rtl - Verilog HDL synthesizable sources \
sim - testbenches written in Python and Verilog

### Required software
- Open-source flow (iCESugar-nano)
    - [hdlmake (v4.1dev1)](http://ohwr.org/project/hdl-make) (build system)
    ...
    - [icesprog (v1.1b)](https://github.com/wuxx/icesugar/tree/master/tools/src) (device programming and debug)
- Gowin flow (Tang Primer 20K)
    - [Gowin EDA Education (v1.9.11.03)](https://www.gowinsemi.com/en/support/home/)
- Xilinx flow (PYNQ-Z1, SITLINV)
    - [Vivado (2023.2.1)](https://www.xilinx.com/products/design-tools/vivado.html)
- Simulation
    - [cocotb (v2.0.0)](https://github.com/cocotb/cocotb)
    - [pytest (v9.0.0)](https://docs.pytest.org/en/9.0.x/)
    - [Icarus Verilog (v11.0)](https://github.com/steveicarus/iverilog)
    - [GTKWave (v3.3.104)](https://github.com/gtkwave/gtkwave) (displays the .vcd waveforms generated by Icarus Verilog)
...
### Simulation
- Run simulation for the whole design: `SIM=icarus HDL_TOPLEVEL_LANG=verilog pytest sim -s`
- Run simulation for a specific module:
    1. `cd sim/<module name>`
    2. `SIM=icarus HDL_TOPLEVEL_LANG=verilog pytest test_<module name>.py -s`
...
### Operating time
Platform        |     Flow     |  1 GB   |  2 GB    | Blocks per transaction |  OTP/SD clk (MHz) |
----------------|--------------|---------|----------|------------------------|-------------------|
ICESugar-nano   | Open-source  | 13m 23s |  27m 4s  |           8            |   36/18           |
Tang Primer 20K | Gowin        | 5m 35s  |  10m 57s |           16           |   175/50          |
PYNQ-Z1         | Xilinx       | 3m 54s  |  6m 24s  |           128          |   175/50          |
PGL22G          | Pangomicro   |         |          |                        |                   |
