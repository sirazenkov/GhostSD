...
set_clock_groups -name sysNfast -logically_exclusive -group [get_clocks [list sys_clk_pin [get_clocks -of_objects [get_pins clock_divider_inst/clk_gen_inst/inst/mmcm_adv_inst/CLKOUT1]]]]
