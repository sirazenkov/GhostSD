...
set_input_delay -clock [get_clocks sd_clk_out] -min 2.500 [get_ports -filter { NAME =~  "*io*" && DIRECTION == "INOUT" }]
set_input_delay -clock [get_clocks sd_clk_out] -max 14.000 [get_ports -filter { NAME =~  "*io*" && DIRECTION == "INOUT" }]
set_output_delay -clock [get_clocks sd_clk_out] -min -2.000 [get_ports -filter { NAME =~  "*io*" && DIRECTION == "INOUT" }]
set_output_delay -clock [get_clocks sd_clk_out] -max 6.000 [get_ports -filter { NAME =~  "*io*" && DIRECTION == "INOUT" }]
