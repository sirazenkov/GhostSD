...
create_generated_clock -name slow_clk \
                       -source [get_pins clock_divider_inst/clk_gen_inst/inst/mmcm_adv_inst/CLKOUT1] \
                       -divide_by 128 \
                       [get_pins clock_divider_inst/counter_reg[6]/Q]

create_generated_clock -name sd_fast_clk \
                       -source [get_pins clock_divider_inst/clk_gen_inst/inst/mmcm_adv_inst/CLKOUT1] \
                       -master_clock [get_clocks -of_objects [get_pins clock_divider_inst/clk_gen_inst/inst/mmcm_adv_inst/CLKOUT1]] \
                       -divide_by 1 \
                       [get_pins clock_divider_inst/BUFGMUX_CTRL_inst/O] \
                       -add
create_generated_clock -name sd_slow_clk \
                       -source [get_pins clock_divider_inst/counter_reg[6]/Q] \
...
set_clock_groups -group [get_clocks -of_objects [get_pins clock_divider_inst/clk_gen_inst/inst/mmcm_adv_inst/CLKOUT0]] -group [get_clocks {sd_fast_clk}] -asynchronous
set_clock_groups -group [get_clocks -of_objects [get_pins clock_divider_inst/clk_gen_inst/inst/mmcm_adv_inst/CLKOUT0]] -group [get_clocks {sd_slow_clk}] -asynchronous

set_clock_groups -group [get_clocks -include_generated_clocks sd_fast_clk] -group [get_clocks -include_generated_clocks sd_slow_clk] -logically_exclusive
