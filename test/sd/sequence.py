...
ovalues = [
          [    0,         0,         0,          1,        55,              (1 << 16) - 1,      0,         0,        0,       0    ], # IDLE   -> CMD55
          ...
          [    0,         0,         0,          1,        55,              (1 << 16) - 1,      0,         0,        0,       0    ], # IDLE   -> CMD55
          [    0,         0,         0,          1,        41,      (1 << 31) | (3 << 20),      0,         0,        0,       0    ], # CMD55  -> ACMD41
          [    0,         0,         0,          1,        55,              (1 << 16) - 1,      0,         0,        0,       0    ], # ACMD41 -> CMD55
          [    0,         0,         0,          1,        41,      (1 << 31) | (3 << 20),      0,         0,        0,       0    ], # CMD55  -> ACMD41
          [    0,         0,         0,          1,         2,              (1 << 32) - 1,      0,         0,        0,       0    ], # ACMD41 -> CMD2
          [    0,         0,         0,          1,         3,              (1 << 32) - 1,      0,         0,        0,       0    ], # CMD2   -> CMD3
          [    0,         0,         0,          1,         9,  (RCA << 16) | ((1<<16)-1),      0,         0,        0,       0    ], # CMD3   -> CMD9
          [    0,         0,         0,          1,         7,  (RCA << 16) | ((1<<16)-1),      0,         0,        0,       0    ], # CMD9   -> CMD7
          [    0,         0,         0,          1,        55,  (RCA << 16) | ((1<<16)-1),      0,         0,        0,       0    ], # CMD7   -> CMD55
          [    0,         0,         1,          0,         0,              (1 << 32) - 1,      0,         0,        1,       0    ], # CMD55  -> IDLE
          ...
          [    1,         0,         0,          0,        19,              (1 << 32) - 1,      0,         0,        0,       0    ], # CMD18  -> READ
          [    1,         0,         0,          1,        12,              (1 << 32) - 1,      0,         0,        0,       0    ], # READ   -> CMD12
          [    1,         0,         0,          1,        55,  (RCA << 16) | ((1<<16)-1),      0,         0,        0,       0    ], # CMD12  -> CMD55
          ...
          [    1,         0,         0,          1,        15,  (RCA << 16) | ((1<<16)-1),      0,         0,        0,       0    ], # CMD13  -> CMD15
